...
def get_sample_tts_data() -> List[str]:
    """
    TTS 평가용 텍스트 데이터 생성

    Returns:
        List[str]: TTS 합성할 텍스트 리스트
    """
    return [
        "안녕하세요, 카드 상담 서비스입니다.",
        "카드 분실 신고 접수 도와드리겠습니다.",
        "본인 확인을 위해 생년월일을 말씀해 주시겠어요?",
        "네, 확인되었습니다. 카드 재발급 신청 도와드릴까요?",
        "재발급 신청이 완료되었습니다. 약 5~7일 내에 등록된 주소로 배송됩니다.",
        "추가로 도움이 필요하신 사항이 있으신가요?",
        "이용해 주셔서 감사합니다. 좋은 하루 되세요.",
        "결제 내역 조회를 원하시면 카드번호 뒤 4자리를 말씀해 주세요.",
        "고객님의 이번 달 결제 예정 금액은 125,000원입니다.",
        "상담원 연결을 원하시면 잠시만 기다려 주세요.",
    ]
