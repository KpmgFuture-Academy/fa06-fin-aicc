"""
VITO(Return Zero) STT WebSocket client with diarization plus content-emotion analysis.
"""
...
class VitoSTTWithCustomerEmotionService:
    """
    Composite service:
    1) runs VITO STT (with diarization if requested) over WebSocket
