# 생성된 음성 ce_anger_samples2 폴더에 저장
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path(__file__).parent / "fixtures" / "ce_anger_samples2",
        help="생성된 오디오 파일을 저장할 디렉터리",
    )
    parser.add_argument("--voice", default="onyx", help="TTS voice preset (예: onyx)")
